...
Config.tirePopping = {
    ...
    -- Whether offroad tires should be exluded from the popping mechanic
    offroadTiresGodmode = true,
    
    -- Minimum wheel depth for the tire to be able to pop
    minimumDepth = 60,
    
    -- The chance of the tire popping (this is also calculated with the wheel speed, so the faster the wheel spins the higher chance of it popping)
    poppingChanceMultiplier = 2,
}
