...
if config.AddonList.crewPhone then
    ...
    exports('Cal', function(link, mp3)
        ...
        if #calanMuzikler <= 99 then
            ...
            vRP.notify("Persoanele din apropiere nu pot auzi sunetul videoclipului pe care l-ați deschis, deoarece mai multe persoane folosesc aplicația YouTube.r", "error")
        end
    end)
