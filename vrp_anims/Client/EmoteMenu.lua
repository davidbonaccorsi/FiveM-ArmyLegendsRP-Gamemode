...
RegisterNetEvent("vrp-anims:forceSendAnimRequest", function(target, emote)
  TriggerServerEvent("ServerEmoteRequest", target, ShareTable[emote], "shared")
end)
